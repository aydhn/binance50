...
- Phase 26: Portfolio candidate selection sandbox; signal/risk/ML-blend adaylarını correlation, similarity, exposure, concentration, diversification, risk budget ve constraint checks altında sandbox-only ranked selected candidates olarak üretir; production allocation/position sizing/paper/live write kapalı kalır.
- Phase 27: Phase 27’de portfolio construction sandbox v1 kurulacak; seçilmiş adaylar için hypothetical allocation, risk parity/volatility targeting skeleton ve capital allocation report üretilecek, production execution hâlâ kapalı kalacak.
