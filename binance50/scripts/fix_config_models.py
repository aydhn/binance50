...
content = content.replace("indicators: IndicatorsConfig = Field(default_factory=IndicatorsConfig)", "    indicators: IndicatorsConfig = Field(default_factory=IndicatorsConfig)")
