...
content = content.replace(
    "def build_stream_url_from_plan(self, plan: StreamSubscriptionPlan)",
    "def build_stream_url_from_plan(self, plan: 'StreamSubscriptionPlan')",
)
content = content.replace(
    "def subscribe(self, plan: StreamSubscriptionPlan)",
    "def subscribe(self, plan: 'StreamSubscriptionPlan')",
)
content = content.replace(
    "def unsubscribe(self, plan: StreamSubscriptionPlan)",
    "def unsubscribe(self, plan: 'StreamSubscriptionPlan')",
)
content = content.replace(
