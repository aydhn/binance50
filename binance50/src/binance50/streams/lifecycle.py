...
def build_stream_lifecycle(
    config: AppConfig, started_at_utc: datetime | None = None
) -> StreamConnectionLifecycle:
...
def record_ping(
    lifecycle: StreamConnectionLifecycle, now_utc: datetime | None = None
) -> StreamConnectionLifecycle:
    if not now_utc:
        now_utc = get_utc_now()
...
def is_pong_timeout(
    lifecycle: StreamConnectionLifecycle, config: AppConfig, now_utc: datetime | None = None
) -> bool:
