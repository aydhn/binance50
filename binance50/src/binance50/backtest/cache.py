...
def build_backtest_cache_path(config, symbol: str, market_scope: str, interval: str, config_hash: str) -> Path:
    return Path(config.backtest.cache_dir) / f"{symbol}_{market_scope}_{interval}_{config_hash}.json"
