...
from binance50.signals.explanations import build_score_explanation, build_confluence_explanation, build_score_breakdown_explanation, validate_scored_signal_explanation
...
def scored():
    ...
    return ScoredSignalCandidate(
        ...
        score_breakdown=breakdown, explanation="Candidate generated safely"
    )
