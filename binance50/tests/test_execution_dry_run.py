...
from binance50.execution.dry_run import ExecutionDryRunValidator
...
def test_dry_run_validator():
    config = get_config()
    validator = ExecutionDryRunValidator(config)
    ...
    result = validator.run_dry_validation(intent, {})
