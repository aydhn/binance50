...
from binance50.signals.freshness import compute_candidate_age_bars, is_candidate_expired, compute_freshness_multiplier, compute_freshness_component
...
@pytest.fixture
def candidate():
    dt = int(datetime.now(timezone.utc).timestamp() * 1000)
    ...
    return SignalCandidate(
        ...
        confidence=80.0, explanation=exp, expiry_bars=3
    )
